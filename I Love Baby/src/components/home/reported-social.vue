  ...
  <div class="template-content post-box social-box">
    <div class="filter clearfloat">
      ...
      <div class="select-box clearfloat">
        ...
        <div class="xiala-box">
          <v-selection :selections="postStatusList" :selectionactive="postStatus" @on-change="onStatusChange($event)"></v-selection>
        </div>
      </div>
      <div class="select-box clearfloat">
  ...
  export default {
    ...
    methods: {
      ...
      searchClick() {
        ...
        if(this.startTime) {
          this.socialSelectJson.sTime = this.startTime;
        } else {
          delete this.socialSelectJson.sTime;
        }
        if(this.endTime) {
          this.socialSelectJson.eTime = this.endTime;
        } else {
