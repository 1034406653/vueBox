  ...
  <div class="template-content  post-box">
    <div class="filter clearfloat">
      ...
      <div class="select-box clearfloat">
        ...
        <div class="xiala-box">
          <v-selection :selections="buyTypes" :selectionactive="status" @on-change="onParamChange($event)"></v-selection>
        </div>
      </div>
      <div class="select-box clearfloat">
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr>
            ...
            <th width="10%">Page view</th>
            <th width="10%">Comments</th>
            <th width="10%">Psot id</th>
            <th width="13%">Operate</th>
          </tr>
        </thead>
        <tr v-for="trLi in trList" :key="trLi.postId">
          <td :title="trLi.content?trLi.content:'--'">{{trLi.content?trLi.content:"--"}}</td>
          <td>{{trLi.auth?trLi.auth:"--"}}</td>
